...
# Output files
GPU_LOG="gpu_perf_vec_openmp.csv"
CPU_LOG="cpu_perf_vec_openmp.csv"

# Clean up previous files
rm -f vecadd_cpu vecadd_gpu $GPU_LOG $CPU_LOG
