...
int main(int argc, char **argv) {
    ...
    // Each iteration involves roughly 2*Ndim^2 FLOPs (Ndim*(2*(Ndim-1)) for sum
    // + 2*Ndim for update)
    ...
    // (stored in xnew) and comparing with the original right-hand side vector
    // b.
